...
`http://ccs.github.neu.edu` (now retired/unavailable). You should have access to that with your
...
(PR)](https://github.com/jasonhemann/21FA-CS3800) for a quick
...
[documentation](https://web.archive.org/web/20200815193823/http://khoury.northeastern.edu/systems/vdi/). You
have many options including using an HTML client
